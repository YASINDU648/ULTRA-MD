...
const defaultOwner = '94760229885';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS = '94760229885';  // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER = '94711366464';  // put your number here
global.SESSION_ID = process.env.SESSION_ID = 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['94760229885']
